...
class TestAnalyticsService:
    ...
    @pytest.mark.asyncio
    async def test_get_top_keywords(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_top_keywords_default_limit(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_top_products_by_click(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_top_products_by_view(
        self,
        service,
        mock_postgres_repo
    ):
        ...
        # Arrange
        products_data = [
            {"product_id": "PROD-001", "view_count": 200}
        ]
        mock_postgres_repo.get_top_products.return_value = products_data
    ...
    @pytest.mark.asyncio
    async def test_get_search_patterns(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_top_keywords_empty_results(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_top_products_invalid_metric(
        self,
        service,
        mock_postgres_repo
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_trending_queries_no_trends(
        self,
        service,
        mock_postgres_repo
    ):
