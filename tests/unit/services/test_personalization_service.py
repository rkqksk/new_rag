...
class TestPersonalizationService:
    ...
    def service(self, mock_redis_repo, mock_postgres_repo):
        ...
        with patch('app.services.personalization_service.AdvancedPersonalizationService') as mock_service_class:
    ...
    @pytest.mark.asyncio
    async def test_track_interaction_click(
        self,
        service,
        sample_session_id,
        sample_product
    ...
    @pytest.mark.asyncio
    async def test_track_interaction_view(
        self,
        service,
        sample_session_id,
        sample_product
    ...
    @pytest.mark.asyncio
    async def test_track_interaction_bookmark(
        self,
        service,
        sample_session_id,
        sample_product
    ...
    @pytest.mark.asyncio
    async def test_get_profile_new_user(
        self,
        service,
        sample_session_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_recommendations_empty_products(
        self,
        service,
        sample_session_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_adaptive_weights_supplier_focused(
        self,
        service,
        sample_session_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_adaptive_weights_compatibility_focused(
        self,
        service,
        sample_session_id
    ):
    ...
    @pytest.mark.asyncio
    async def test_track_interaction_failure(
        self,
        service,
        sample_session_id,
        sample_product
