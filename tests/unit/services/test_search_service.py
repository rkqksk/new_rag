...
class TestSearchService:
    ...
    def service(self, mock_qdrant_repo, mock_redis_repo, mock_postgres_repo):
        ...
        with patch('app.services.search_service.MultiModalEmbedder') as mock_embedder_class, \
             ...
             patch('app.services.search_service.AdvancedPersonalizationService') as mock_personalization_class:
