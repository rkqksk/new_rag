...
class TestSearchAPI:
    ...
    def mock_dependencies(self, sample_search_results, sample_products):
        ...
        with patch("app.dependencies.services.get_search_service") as mock_service:
            ...
            async def mock_image_search(image_path, session_id, top_k):
                return {"results": sample_products[:2], "total": 2, "session_id": session_id}

            service.image_search = mock_image_search

            # Mock hybrid_search method
            async def mock_hybrid_search(
                query, image_path, text_weight, image_weight, session_id, top_k
            ):
                return {
                    "results": sample_products,
                    "total": len(sample_products),
    ...
    def test_search_without_session(self):
        ...
        # Arrange
        request_data = {"query": "20파이 캡", "top_k": 10, "use_cache": False}
    ...
    def test_search_with_cache(self):
        ...
        # Arrange
        request_data = {"query": "50ml 용기", "use_cache": True}
    ...
    def test_hybrid_search_text_only(self):
        ...
        response = client.post(
            "/api/v1/search/hybrid",
            data={"query": "20파이 캡", "text_weight": "1.0", "image_weight": "0.0", "top_k": "10"},
        )
    ...
    def test_search_special_characters(self):
        ...
        # Arrange
        request_data = {"query": "20파이 캡 (PP재질) 5,000개", "top_k": 20}
    ...
    def test_search_concurrent_requests(self):
        ...
        for query in queries:
            response = client.post("/api/v1/search/", json={"query": query, "top_k": 10})
