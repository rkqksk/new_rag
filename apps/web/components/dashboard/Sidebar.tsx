...
const navItems: NavItem[] = [
  ...
  { title: "크롤링 스케줄러", href: "/admin/crawling/scheduler", icon: "📅", roles: ["super-user", "admin", "manager"] },
  { title: "Webhook 관리", href: "/admin/webhooks", icon: "🔔", roles: ["super-user", "admin", "manager"] },
  { title: "기능 설정", href: "/admin/settings", icon: "⚙️", roles: ["super-user", "admin", "manager"] },
    ...
    <div className="flex h-screen w-64 flex-col border-r border-stone-800 bg-black">
      ...
      <div className="p-6">
        <Link href="/" className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-xl font-bold text-stone-100">PETER</h1>
