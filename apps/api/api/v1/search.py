...
async def search(request: SearchRequest, service: SearchService = Depends(get_search_service)):
    """
...
async def image_search(
    ...
    try:
        result = await service.image_search(image_path=tmp_path, session_id=session_id, top_k=top_k)
        return result
    finally:
        # Cleanup
