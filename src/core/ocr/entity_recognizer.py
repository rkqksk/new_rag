...
class EntityRecognizer:
    ...
    def _init_patterns(self) -> Dict[str, List[Dict]]:
        ...
        return {
            ...
            "material": [
                ...
                {
                    "pattern": r"\b(PET|PP|PE|PETG|HDPE|LDPE|PS|PVC)\b",
                    "confidence": 0.75,
                },  # Standalone
            ],
            "moq": [
    ...
    def _extract_entity(
        self, text: str, entity_type: str, patterns: List[Dict]
        ...
        for pattern_dict in patterns:
            ...
            if match:
                ...
                return ExtractedEntity(
                    field=entity_type, value=value, confidence=confidence, pattern=pattern
                )
