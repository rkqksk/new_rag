#!/usr/bin/env python3
"""
JAR 카테고리 데이터 정리 스크립트
test_jar_category → crawled_products_organized/Jar
"""
...
# 경로 설정
SOURCE_DIR = Path("data/test_jar_category")
TARGET_DIR = Path("data/crawled_products_organized/Jar")
CATEGORY_JSON = SOURCE_DIR / "category_Jar_20251018_025258.json"
...
def generate_csv_report():
    ...
    csv_path = TARGET_DIR / "Jar_report.csv"
