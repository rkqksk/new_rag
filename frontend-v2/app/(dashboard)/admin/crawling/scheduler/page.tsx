  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <StatCard title="전체 스케줄" value={stats.total} icon="📅" />
        <StatCard title="활성 스케줄" value={stats.active} icon="✅" changeType="neutral" />
        <StatCard title="비활성 스케줄" value={stats.inactive} icon="⏸️" changeType="neutral" />
        <StatCard
          title="다음 실행"
