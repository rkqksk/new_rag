                    ...
                    <TableRow key={endpoint.endpoint} className="border-stone-900 hover:bg-stone-950">
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm ${endpoint.avg_response_time > 1000 ? 'text-yellow-400' : 'text-stone-300'}`}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <span className={`text-sm ${endpoint.error_rate > 2 ? 'text-red-400' : 'text-stone-300'}`}>
                            {endpoint.error_rate}%
                          </span>
                        </div>
                      </TableCell>
